...
/* C:\Users\TATAJDJ\Proyectos\soyorganico\install-master/themes/zwiebl-zwiebl_stellar/layouts/soyorganico.htm */
class __TwigTemplate_1d1539e62e93bf7b1066e7790e0c267c8bc47441f60af9d9b5e792f3ee6f7041 extends \Twig\Template
{
    private $source;
    private $macros = [];
...
<body>
    <div id=\"wrapper\">
        ...
        if (twig_get_attribute($this->env, $this->source, twig_get_attribute($this->env, $this->source, ($context["this"] ?? null), "theme", [], "any", false, false, false, 12), "show_section_one", [], "any", false, false, false, 12)) {
            ...
            echo "                ";
            $context['__cms_partial_params'] = [];
            echo $this->env->getExtension('Cms\Twig\Extension')->partialFunction("home_page/section_nosotros"            , $context['__cms_partial_params']            , true            );
            unset($context['__cms_partial_params']);
            // line 14
            echo "            ";
        }
        ...
        if (twig_get_attribute($this->env, $this->source, twig_get_attribute($this->env, $this->source, ($context["this"] ?? null), "theme", [], "any", false, false, false, 16), "show_section_two", [], "any", false, false, false, 16)) {
            ...
            echo "                ";
            $context['__cms_partial_params'] = [];
            echo $this->env->getExtension('Cms\Twig\Extension')->partialFunction("home_page/section_productos"            , $context['__cms_partial_params']            , true            );
            unset($context['__cms_partial_params']);
            // line 18
            echo "            ";
        }
        ...
        if (twig_get_attribute($this->env, $this->source, twig_get_attribute($this->env, $this->source, ($context["this"] ?? null), "theme", [], "any", false, false, false, 20), "show_section_three", [], "any", false, false, false, 20)) {
            ...
            echo "                ";
            $context['__cms_partial_params'] = [];
            echo $this->env->getExtension('Cms\Twig\Extension')->partialFunction("home_page/section_recetas"            , $context['__cms_partial_params']            , true            );
            unset($context['__cms_partial_params']);
            // line 22
            echo "            ";
        }
        ...
        if (twig_get_attribute($this->env, $this->source, twig_get_attribute($this->env, $this->source, ($context["this"] ?? null), "theme", [], "any", false, false, false, 24), "show_section_four", [], "any", false, false, false, 24)) {
            ...
            echo "                ";
            $context['__cms_partial_params'] = [];
            echo $this->env->getExtension('Cms\Twig\Extension')->partialFunction("home_page/section_contacto"            , $context['__cms_partial_params']            , true            );
            unset($context['__cms_partial_params']);
            // line 26
            echo "            ";
        }
    ...
    {
        return "C:\\Users\\TATAJDJ\\Proyectos\\soyorganico\\install-master/themes/zwiebl-zwiebl_stellar/layouts/soyorganico.htm";
    }
    ...
    <div id=\"wrapper\">
        ...
        <div id=\"main\">
            ...
            {% if this.theme.show_section_one %}
                {% partial \"home_page/section_nosotros\" %}
            {% endif %}

            {% if this.theme.show_section_two %}
                {% partial \"home_page/section_productos\" %}
            {% endif %}

            {% if this.theme.show_section_three %}
                {% partial \"home_page/section_recetas\" %}
            {% endif %}

            {% if this.theme.show_section_four %}
                {% partial \"home_page/section_contacto\" %}
            {% endif %}
        </div>
...
</html>", "C:\\Users\\TATAJDJ\\Proyectos\\soyorganico\\install-master/themes/zwiebl-zwiebl_stellar/layouts/soyorganico.htm", "");
    }
}
